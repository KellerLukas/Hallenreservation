...
from src.utils.config import (O365_CLIENT_ID_ENV_VAR, O365_CREDS_OP_UUID, O365_SECRET_ENV_VAR,
    OP_VAULT_UUID, SERVICE_ACCOUNT_TOKEN_OP_UUID)
...
def get_o365_credentials_from_env() -> Tuple[str,str]:
    return get_credentials_from_env_var(O365_CLIENT_ID_ENV_VAR), get_credentials_from_env_var(O365_SECRET_ENV_VAR)

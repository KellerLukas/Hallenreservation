...
class EmailProcessor:
    def __init__(self, message: Message, account: Account):
        ...
        self.find_attachment_meta = FindAttachmentMeta(message_body=self.message.body, message_subject=self.message.subject)
    ...
    def process_attachment(self, attachment: MessageAttachment):
        ...
        meta = self.find_attachment_meta.find(attachment_name=attachment.name, attachment_content=pdf_text)
